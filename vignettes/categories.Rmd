...
It is helpful to be aware of various categories of data that are available.
From a given category, there are sub-categories (reports) for which one can query data.
The first call below does not include a category id.
The result is a data.frame of all available categories.
The second call shows all subcategories under which data is available.
...
The category IDs from above can be used to obtain subcategories (reports) for
which datea can be obtained.
