...
```r
system.time(eia_directory()) # API call; cache result
system.time(eia_directory()) # read from cache
system.time(eia_directory(cache = FALSE)) # API call
```
