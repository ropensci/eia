...
#>    <chr>            <chr>                        <chr> <chr>    <chr>      
#>  1 ELEC.CONS_TOT_B~ Total consumption (Btu) : c~ A     million~ 23-OCT-19 ~
#>  2 ELEC.CONS_TOT_B~ Total consumption (Btu) : c~ M     million~ 23-OCT-19 ~
#>  3 ELEC.CONS_TOT_B~ Total consumption (Btu) : c~ Q     million~ 23-OCT-19 ~
#>  4 ELEC.CONS_TOT_B~ Total consumption (Btu) : c~ A     million~ 23-OCT-19 ~
#>  5 ELEC.CONS_TOT_B~ Total consumption (Btu) : c~ M     million~ 23-OCT-19 ~
#>  6 ELEC.CONS_TOT_B~ Total consumption (Btu) : c~ Q     million~ 23-OCT-19 ~
#>  7 ELEC.CONS_TOT_B~ Total consumption (Btu) : c~ A     million~ 23-OCT-19 ~
#>  8 ELEC.CONS_TOT_B~ Total consumption (Btu) : c~ M     million~ 23-OCT-19 ~
#>  9 ELEC.CONS_TOT_B~ Total consumption (Btu) : c~ Q     million~ 23-OCT-19 ~
#> 10 ELEC.CONS_TOT_B~ Total consumption (Btu) : c~ A     million~ 23-OCT-19 ~
#> # ... with 164 more rows
```
...
#> 2 0.848 2019-07-01  2019     7
#> 3 0.805 2019-06-01  2019     6
x3$data[[1]]
#> # A tibble: 3 x 4
#>   value date        year   qtr
#>   <dbl> <date>     <int> <int>
#> 1 NA    2019-04-01  2019     2
#> 2 NA    2019-01-01  2019     1
...
#> 2 ELEC.CON~ Tota~ mill~ M     "Summation~ None      EIA, ~ USA-AK 
#> 3 ELEC.CON~ Tota~ mill~ Q     "Summation~ None      EIA, ~ USA-AK 
...
#> 5 ELEC.CONS_TOT_BTU.COW-AK-98.M  0.848 2019-07-01  2019     7    NA
#> 6 ELEC.CONS_TOT_BTU.COW-AK-98.M  0.805 2019-06-01  2019     6    NA
#> 7 ELEC.CONS_TOT_BTU.COW-AK-98.Q NA     2019-04-01  2019    NA     2
#> 8 ELEC.CONS_TOT_BTU.COW-AK-98.Q NA     2019-01-01  2019    NA     1
...
#> $series
#>                       series_id
#> 1 ELEC.CONS_TOT_BTU.COW-AK-98.A
#> 2 ELEC.CONS_TOT_BTU.COW-AK-98.M
#> 3 ELEC.CONS_TOT_BTU.COW-AK-98.Q
#>                                                                           name
#> 1    Total consumption (Btu) : coal : Alaska : electric power (total) : annual
#> 2   Total consumption (Btu) : coal : Alaska : electric power (total) : monthly
#> 3 Total consumption (Btu) : coal : Alaska : electric power (total) : quarterly
#>           units f
#> 1 million MMBtu A
#> 2 million MMBtu M
#> 3 million MMBtu Q
#>                                                                                                   description
#> 1 Summation of all types of coal; Power plants owned by companies whose primary purpose is to produce power; 
#> 2 Summation of all types of coal; Power plants owned by companies whose primary purpose is to produce power; 
#> 3 Summation of all types of coal; Power plants owned by companies whose primary purpose is to produce power; 
#>   copyright                                      source iso3166 geography
#> 1      None EIA, U.S. Energy Information Administration  USA-AK    USA-AK
#> 2      None EIA, U.S. Energy Information Administration  USA-AK    USA-AK
#> 3      None EIA, U.S. Energy Information Administration  USA-AK    USA-AK
#>    start    end                  updated
#> 1   2001   2018 2019-10-23T18:58:10-0400
#> 2 200101 201908 2019-10-23T18:58:10-0400
#> 3 2001Q1 2019Q2 2019-10-23T18:58:10-0400
#>                                                data
#> 1      2018, 2017, 2016, 10.37727, 9.21412, 9.64353
#> 2 201908, 201907, 201906, 0.85395, 0.84755, 0.80542
#> 3           2019Q2, 2019Q1, 2018Q4, NA, NA, 3.16491
```
...
#> 2 ELEC.CON~ Tota~ mill~ M     "Summation~ None      EIA, ~ USA-AK 
#> 3 ELEC.CON~ Tota~ mill~ Q     "Summation~ None      EIA, ~ USA-AK 
#> # ... with 4 more variables: geography <chr>, start <chr>, end <chr>,
#> #   updated <chr>
...
#> 2 ELEC.CONS_TOT_BTU.COW-AK-98.M 2019-10-23T18:58:10-0400
#> 3 ELEC.CONS_TOT_BTU.COW-AK-98.Q 2019-10-23T18:58:10-0400
eia_series_dates(id)
#> # A tibble: 316 x 4
...
#> 1 ELEC.CONS_TOT_BTU.C~ 2001-01-01 2018-01-01 2001   2018  A              18
#> 2 ELEC.CONS_TOT_BTU.C~ 2001-01-01 2019-08-01 200101 2019~ M             224
#> 3 ELEC.CONS_TOT_BTU.C~ 2001-01-01 2019-04-01 2001Q1 2019~ Q              74
eia_series_cats(id)
#> # A tibble: 6 x 3
...
#>   series_id                    updated                 
#>   <chr>                        <chr>                   
#> 1 ELEC.CONS_TOT_BTU.COW-AK-1.A 2019-10-23T18:58:10-0400
#> 2 ELEC.CONS_TOT_BTU.COW-AK-1.M 2019-10-23T18:58:10-0400
#> 3 ELEC.CONS_TOT_BTU.COW-AK-1.Q 2019-10-23T18:58:10-0400
#> 4 ELEC.CONS_TOT_BTU.COW-AL-1.A 2019-10-23T18:58:10-0400
#> 5 ELEC.CONS_TOT_BTU.COW-AL-1.M 2019-10-23T18:58:10-0400
```
