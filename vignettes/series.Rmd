...
#>    <chr>                         <chr>                                                                          <chr> <chr>         <chr>                
#>  1 ELEC.CONS_TOT_BTU.COW-AK-98.A Total consumption (Btu) : coal : Alaska : electric power (total) : annual      A     million MMBtu 27-NOV-19 04.57.27 PM
#>  2 ELEC.CONS_TOT_BTU.COW-AK-98.M Total consumption (Btu) : coal : Alaska : electric power (total) : monthly     M     million MMBtu 27-NOV-19 04.57.27 PM
#>  3 ELEC.CONS_TOT_BTU.COW-AK-98.Q Total consumption (Btu) : coal : Alaska : electric power (total) : quarterly   Q     million MMBtu 27-NOV-19 04.57.27 PM
#>  4 ELEC.CONS_TOT_BTU.COW-AL-98.A Total consumption (Btu) : coal : Alabama : electric power (total) : annual     A     million MMBtu 27-NOV-19 04.57.27 PM
#>  5 ELEC.CONS_TOT_BTU.COW-AL-98.M Total consumption (Btu) : coal : Alabama : electric power (total) : monthly    M     million MMBtu 27-NOV-19 04.57.27 PM
#>  6 ELEC.CONS_TOT_BTU.COW-AL-98.Q Total consumption (Btu) : coal : Alabama : electric power (total) : quarterly  Q     million MMBtu 27-NOV-19 04.57.27 PM
#>  7 ELEC.CONS_TOT_BTU.COW-AR-98.A Total consumption (Btu) : coal : Arkansas : electric power (total) : annual    A     million MMBtu 27-NOV-19 04.57.27 PM
#>  8 ELEC.CONS_TOT_BTU.COW-AR-98.M Total consumption (Btu) : coal : Arkansas : electric power (total) : monthly   M     million MMBtu 27-NOV-19 04.57.27 PM
#>  9 ELEC.CONS_TOT_BTU.COW-AR-98.Q Total consumption (Btu) : coal : Arkansas : electric power (total) : quarterly Q     million MMBtu 27-NOV-19 04.57.27 PM
#> 10 ELEC.CONS_TOT_BTU.COW-AZ-98.A Total consumption (Btu) : coal : Arizona : electric power (total) : annual     A     million MMBtu 27-NOV-19 04.57.27 PM
#> # ... with 164 more rows
```
...
#>   <dbl> <date>     <int> <int>
#> 1 0.748 2019-09-01  2019     9
#> 2 0.854 2019-08-01  2019     8
#> 3 0.852 2019-07-01  2019     7
x3$data[[1]]
#> # A tibble: 3 x 4
#>   value date        year   qtr
#>   <dbl> <date>     <int> <int>
#> 1  2.45 2019-07-01  2019     3
#> 2 NA    2019-04-01  2019     2
#> 3  3.01 2019-01-01  2019     1
```
...
#> 1 ELEC.CONS_TOT_~ Total consumption (Btu) ~ million~ A     "Summation of all types of coal; Powe~ None      EIA, U.S. Ener~ USA-AK  USA-AK    2001  2018  2019-11-27~ <tibbl~
#> 2 ELEC.CONS_TOT_~ Total consumption (Btu) ~ million~ M     "Summation of all types of coal; Powe~ None      EIA, U.S. Ener~ USA-AK  USA-AK    2001~ 2019~ 2019-11-27~ <tibbl~
#> 3 ELEC.CONS_TOT_~ Total consumption (Btu) ~ million~ Q     "Summation of all types of coal; Powe~ None      EIA, U.S. Ener~ USA-AK  USA-AK    2001~ 2019~ 2019-11-27~ <tibbl~
```
...
#> 4 ELEC.CONS_TOT_BTU.COW-AK-98.M  0.748 2019-09-01  2019     9    NA
#> 5 ELEC.CONS_TOT_BTU.COW-AK-98.M  0.854 2019-08-01  2019     8    NA
#> 6 ELEC.CONS_TOT_BTU.COW-AK-98.M  0.852 2019-07-01  2019     7    NA
#> 7 ELEC.CONS_TOT_BTU.COW-AK-98.Q  2.45  2019-07-01  2019    NA     3
#> 8 ELEC.CONS_TOT_BTU.COW-AK-98.Q NA     2019-04-01  2019    NA     2
#> 9 ELEC.CONS_TOT_BTU.COW-AK-98.Q  3.01  2019-01-01  2019    NA     1
```
...
#> 1    USA-AK   2001   2018 2019-11-27T16:57:27-0500      2018, 2017, 2016, 10.37727, 9.21412, 9.64353
#> 2    USA-AK 200101 201909 2019-11-27T16:57:27-0500 201909, 201908, 201907, 0.74759, 0.85395, 0.85228
#> 3    USA-AK 2001Q1 2019Q3 2019-11-27T16:57:27-0500      2019Q3, 2019Q2, 2019Q1, 2.45382, NA, 3.00949
```
...
#> {"request":{"command":"series","series_id":"ELEC.CONS_TOT_BTU.COW-AK-98.A;ELEC.CONS_TOT_BTU.COW-AK-98.M;ELEC.CONS_TOT_BTU.COW-AK-98.Q"},"series":[{"series_id":"ELEC.CONS_TOT_BTU.COW-AK-98.A","name":"Total consumption (Btu) : coal : Alaska : electric power (total) : annual","units":"million MMBtu","f":"A","description":"Summation of all types of coal; Power plants owned by companies whose primary purpose is to produce power; ","copyright":"None","source":"EIA, U.S. Energy Information Administration","iso3166":"USA-AK","geography":"USA-AK","start":"2001","end":"2018","updated":"2019-11-27T16:57:27-0500","data":[["2018",10.37727],["2017",9.21412],["2016",9.64353]]},{"series_id":"ELEC.CONS_TOT_BTU.COW-AK-98.M","name":"Total consumption (Btu) : coal : Alaska : electric power (total) : monthly","units":"million MMBtu","f":"M","description":"Summation of all types of coal; Power plants owned by companies whose primary purpose is to produce power; ","copyright":"None","source":"EIA, U.S. Energy Information Administration","iso3166":"USA-AK","geography":"USA-AK","start":"200101","end":"201909","updated":"2019-11-27T16:57:27-0500","data":[["201909",0.74759],["201908",0.85395],["201907",0.85228]]},{"series_id":"ELEC.CONS_TOT_BTU.COW-AK-98.Q","name":"Total consumption (Btu) : coal : Alaska : electric power (total) : quarterly","units":"million MMBtu","f":"Q","description":"Summation of all types of coal; Power plants owned by companies whose primary purpose is to produce power; ","copyright":"None","source":"EIA, U.S. Energy Information Administration","iso3166":"USA-AK","geography":"USA-AK","start":"2001Q1","end":"2019Q3","updated":"2019-11-27T16:57:27-0500","data":[["2019Q3",2.45382],["2019Q2",null],["2019Q1",3.00949]]}]}
```
...
#> 1 ELEC.CONS_TOT_B~ Total consumption (Btu) : ~ million~ A     "Summation of all types of coal; Power ~ None      EIA, U.S. Energy~ USA-AK  USA-AK    2001  2018  2019-11-27T~
#> 2 ELEC.CONS_TOT_B~ Total consumption (Btu) : ~ million~ M     "Summation of all types of coal; Power ~ None      EIA, U.S. Energy~ USA-AK  USA-AK    2001~ 2019~ 2019-11-27T~
#> 3 ELEC.CONS_TOT_B~ Total consumption (Btu) : ~ million~ Q     "Summation of all types of coal; Power ~ None      EIA, U.S. Energy~ USA-AK  USA-AK    2001~ 2019~ 2019-11-27T~
eia_series_updates(id)
#> # A tibble: 3 x 2
#>   series_id                     updated                 
#>   <chr>                         <chr>                   
#> 1 ELEC.CONS_TOT_BTU.COW-AK-98.A 2019-11-27T16:57:27-0500
#> 2 ELEC.CONS_TOT_BTU.COW-AK-98.M 2019-11-27T16:57:27-0500
#> 3 ELEC.CONS_TOT_BTU.COW-AK-98.Q 2019-11-27T16:57:27-0500
eia_series_dates(id)
#> # A tibble: 318 x 4
...
#> 2 ELEC.CONS_TOT_BTU.COW-AK-98.M 2001-01-01 2019-09-01 200101 201909 M             225
#> 3 ELEC.CONS_TOT_BTU.COW-AK-98.Q 2001-01-01 2019-07-01 2001Q1 2019Q3 Q              75
eia_series_cats(id)
#> # A tibble: 6 x 3
...
#>   series_id                    updated                 
#>   <chr>                        <chr>                   
#> 1 ELEC.CONS_TOT_BTU.COW-AK-1.A 2019-11-27T16:57:27-0500
#> 2 ELEC.CONS_TOT_BTU.COW-AK-1.M 2019-11-27T16:57:27-0500
#> 3 ELEC.CONS_TOT_BTU.COW-AK-1.Q 2019-11-27T16:57:27-0500
#> 4 ELEC.CONS_TOT_BTU.COW-AL-1.A 2019-11-27T16:57:27-0500
#> 5 ELEC.CONS_TOT_BTU.COW-AL-1.M 2019-11-27T16:57:27-0500
```
