...
*Note: This package version of the introduction vignette does not show the results of examples. Code is not executed because an API key is not present. See the full set of examples with code execution at the package [website](https://docs.ropensci.org/eia)*
